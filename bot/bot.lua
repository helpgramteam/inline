...
package.cpath = package.cpath..';.luarocks/lib/lua/5.2/?.so'
    bot_token = "334875186:AAFI7D9ThLrqjRNOpJP8mw-aasVo4dUP3uk" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		tmspecial = '/root/BDکلاسیک'
	elseif not server_user:match("^root$") then
		tmspecial = '/home/'..server_user..'/BDکلاسیک'
	end
  ...
  config = {
    ...
    sudo_users = {381292768,349989145},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..tmspecial..'/data/moderation.json'},
    info_text = [[*》special Helper Bot V1.0*
`》@lyou4ul
]],
  }
