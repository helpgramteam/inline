...
local text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Flood Sensitivity ', callback_data = 'tmspecial'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="tmspecial"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '> Character Sensitivity ', callback_data = 'tmspecial'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="tmspecial"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '> Flood Check Time ', callback_data = 'tmspecial'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="tmspecial"},
...
if msg.cb then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> About Us ', callback_data = '/special:'..matches[2]}
		},
		{
...
if matches[1] == '/special' then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> Our GitHub ', url = 'https://www.github.com/tmspecial'}
		},
		{
...
*-------------------------*]]
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Back", callback_data="/special:"..matches[2]}
		}
	}
    edit_inline(msg.message_id, text, keyboard)
end
